...
class CategoryAdapter(private var categories: List<Category>) :
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
        ...
        if (isOverBudget) {
            ...
            holder.categoryProgress.progressDrawable = ContextCompat.getDrawable(context, R.drawable.progress_bar_red)
            ...
            holder.categoryProgress.progressDrawable = ContextCompat.getDrawable(context, R.drawable.progress_bar_blue)
            val progress = if (category.maxGoal > 0) ((spent / category.maxGoal) * 100).toInt().coerceIn(0, 100) else 0
